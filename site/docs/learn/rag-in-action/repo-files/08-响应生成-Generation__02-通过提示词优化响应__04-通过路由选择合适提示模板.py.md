# 文件：08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py

- 相对路径：`08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py`
- 大小：`4539` bytes
- 原文件：[08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py](/learn/rag-in-action/repo-raw/rag-in-action/08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py)
