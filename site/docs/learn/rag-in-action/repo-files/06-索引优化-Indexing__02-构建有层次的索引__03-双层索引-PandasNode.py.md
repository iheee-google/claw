# 文件：06-索引优化-Indexing/02-构建有层次的索引/03-双层索引-PandasNode.py

- 相对路径：`06-索引优化-Indexing/02-构建有层次的索引/03-双层索引-PandasNode.py`
- 大小：`3872` bytes
- 原文件：[06-索引优化-Indexing/02-构建有层次的索引/03-双层索引-PandasNode.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/03-双层索引-PandasNode.py)
