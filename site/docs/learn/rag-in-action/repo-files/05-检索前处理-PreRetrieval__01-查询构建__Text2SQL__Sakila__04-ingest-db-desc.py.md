# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py`
- 大小：`2772` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py)
