# 文件：04-向量存储-VectorDB/Milvus/a-working-sample.py

- 相对路径：`04-向量存储-VectorDB/Milvus/a-working-sample.py`
- 大小：`3905` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/a-working-sample.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/a-working-sample.py)
