# 文件：09-系统评估-Evaluation/01-RAGAS.py

- 相对路径：`09-系统评估-Evaluation/01-RAGAS.py`
- 大小：`8170` bytes
- 原文件：[09-系统评估-Evaluation/01-RAGAS.py](/learn/rag-in-action/repo-raw/rag-in-action/09-系统评估-Evaluation/01-RAGAS.py)
