# 文件：06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py

- 相对路径：`06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py`
- 大小：`4426` bytes
- 原文件：[06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py)
