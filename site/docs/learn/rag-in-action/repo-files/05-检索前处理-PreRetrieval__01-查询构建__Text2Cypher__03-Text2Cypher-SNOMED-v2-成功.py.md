# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v2-成功.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v2-成功.py`
- 大小：`4250` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v2-成功.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v2-成功.py)
