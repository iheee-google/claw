# 文件：09-系统评估-Evaluation/03-DeepEval.py

- 相对路径：`09-系统评估-Evaluation/03-DeepEval.py`
- 大小：`788` bytes
- 原文件：[09-系统评估-Evaluation/03-DeepEval.py](/learn/rag-in-action/repo-raw/rag-in-action/09-系统评估-Evaluation/03-DeepEval.py)
