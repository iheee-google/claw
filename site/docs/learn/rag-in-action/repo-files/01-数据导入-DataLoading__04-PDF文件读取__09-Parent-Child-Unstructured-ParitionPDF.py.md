# 文件：01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-ParitionPDF.py

- 相对路径：`01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-ParitionPDF.py`
- 大小：`2473` bytes
- 原文件：[01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-ParitionPDF.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-ParitionPDF.py)
