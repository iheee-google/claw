# 文件：01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py

- 相对路径：`01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py`
- 大小：`1509` bytes
- 原文件：[01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py)
