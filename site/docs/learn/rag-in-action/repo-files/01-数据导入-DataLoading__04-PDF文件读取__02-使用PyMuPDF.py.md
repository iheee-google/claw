# 文件：01-数据导入-DataLoading/04-PDF文件读取/02-使用PyMuPDF.py

- 相对路径：`01-数据导入-DataLoading/04-PDF文件读取/02-使用PyMuPDF.py`
- 大小：`1352` bytes
- 原文件：[01-数据导入-DataLoading/04-PDF文件读取/02-使用PyMuPDF.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/02-使用PyMuPDF.py)
