# 文件：01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py

- 相对路径：`01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py`
- 大小：`5166` bytes
- 原文件：[01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py)
