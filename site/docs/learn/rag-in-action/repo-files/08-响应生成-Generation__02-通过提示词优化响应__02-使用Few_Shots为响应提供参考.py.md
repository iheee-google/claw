# 文件：08-响应生成-Generation/02-通过提示词优化响应/02-使用Few Shots为响应提供参考.py

- 相对路径：`08-响应生成-Generation/02-通过提示词优化响应/02-使用Few Shots为响应提供参考.py`
- 大小：`2850` bytes
- 原文件：[08-响应生成-Generation/02-通过提示词优化响应/02-使用Few Shots为响应提供参考.py](/learn/rag-in-action/repo-raw/rag-in-action/08-响应生成-Generation/02-通过提示词优化响应/02-使用Few Shots为响应提供参考.py)
