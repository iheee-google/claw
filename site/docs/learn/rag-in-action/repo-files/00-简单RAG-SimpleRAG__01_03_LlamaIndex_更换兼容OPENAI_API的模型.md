# 文件：00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型

- 相对路径：`00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型`
- 大小：`2638` bytes
- 原文件：[00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型](/learn/rag-in-action/repo-raw/rag-in-action/00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型)
