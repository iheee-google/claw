...
- 相对路径：`01-数据导入-DataLoading/01-简单文本读取/03-04-用LangChain加载目录时跳过错误.py`
- 大小：`751` bytes
- 原文件：[01-数据导入-DataLoading/01-简单文本读取/03-04-用LangChain加载目录时跳过错误.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/03-04-用LangChain加载目录时跳过错误.py)
