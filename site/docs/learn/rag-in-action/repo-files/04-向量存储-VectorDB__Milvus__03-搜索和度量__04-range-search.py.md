# 文件：04-向量存储-VectorDB/Milvus/03-搜索和度量/04-range-search.py

- 相对路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/04-range-search.py`
- 大小：`3727` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/03-搜索和度量/04-range-search.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/04-range-search.py)
