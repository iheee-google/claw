# 文件：00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py

- 相对路径：`00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py`
- 大小：`1465` bytes
- 原文件：[00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py](/learn/rag-in-action/repo-raw/rag-in-action/00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py)
