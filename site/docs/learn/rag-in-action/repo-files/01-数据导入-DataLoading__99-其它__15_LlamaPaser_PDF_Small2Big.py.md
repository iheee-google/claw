# 文件：01-数据导入-DataLoading/99-其它/15_LlamaPaser_PDF_Small2Big.py

- 相对路径：`01-数据导入-DataLoading/99-其它/15_LlamaPaser_PDF_Small2Big.py`
- 大小：`2228` bytes
- 原文件：[01-数据导入-DataLoading/99-其它/15_LlamaPaser_PDF_Small2Big.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/99-其它/15_LlamaPaser_PDF_Small2Big.py)
