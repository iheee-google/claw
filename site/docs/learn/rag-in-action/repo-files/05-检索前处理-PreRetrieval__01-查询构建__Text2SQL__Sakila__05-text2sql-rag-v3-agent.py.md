# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v3-agent.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v3-agent.py`
- 大小：`5738` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v3-agent.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v3-agent.py)
