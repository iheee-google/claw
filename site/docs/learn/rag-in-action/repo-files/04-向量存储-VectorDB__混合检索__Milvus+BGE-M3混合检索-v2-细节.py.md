# 文件：04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v2-细节.py

- 相对路径：`04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v2-细节.py`
- 大小：`6793` bytes
- 原文件：[04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v2-细节.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v2-细节.py)
