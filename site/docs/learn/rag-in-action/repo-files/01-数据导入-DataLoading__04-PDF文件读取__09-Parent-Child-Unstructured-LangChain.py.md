# 文件：01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-LangChain.py

- 相对路径：`01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-LangChain.py`
- 大小：`2291` bytes
- 原文件：[01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-LangChain.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/09-Parent-Child-Unstructured-LangChain.py)
