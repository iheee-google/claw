# 文件：03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py

- 相对路径：`03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py`
- 大小：`2155` bytes
- 原文件：[03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py](/learn/rag-in-action/repo-raw/rag-in-action/03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py)
