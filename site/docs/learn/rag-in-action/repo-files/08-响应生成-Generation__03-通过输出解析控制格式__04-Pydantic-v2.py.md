# 文件：08-响应生成-Generation/03-通过输出解析控制格式/04-Pydantic-v2.py

- 相对路径：`08-响应生成-Generation/03-通过输出解析控制格式/04-Pydantic-v2.py`
- 大小：`2151` bytes
- 原文件：[08-响应生成-Generation/03-通过输出解析控制格式/04-Pydantic-v2.py](/learn/rag-in-action/repo-raw/rag-in-action/08-响应生成-Generation/03-通过输出解析控制格式/04-Pydantic-v2.py)
