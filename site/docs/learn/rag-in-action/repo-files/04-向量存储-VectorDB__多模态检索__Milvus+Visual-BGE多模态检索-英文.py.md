# 文件：04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py

- 相对路径：`04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py`
- 大小：`8084` bytes
- 原文件：[04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py)
