# 文件：91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt

- 相对路径：`91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt`
- 大小：`2771` bytes
- 原文件：[91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt](/learn/rag-in-action/repo-raw/rag-in-action/91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt)
