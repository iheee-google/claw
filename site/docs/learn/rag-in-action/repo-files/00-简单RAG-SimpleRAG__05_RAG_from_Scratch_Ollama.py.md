# 文件：00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Ollama.py

- 相对路径：`00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Ollama.py`
- 大小：`3499` bytes
- 原文件：[00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Ollama.py](/learn/rag-in-action/repo-raw/rag-in-action/00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Ollama.py)
