# 文件：03-向量嵌入-Embedding/03-BM25.py

- 相对路径：`03-向量嵌入-Embedding/03-BM25.py`
- 大小：`1425` bytes
- 原文件：[03-向量嵌入-Embedding/03-BM25.py](/learn/rag-in-action/repo-raw/rag-in-action/03-向量嵌入-Embedding/03-BM25.py)
