# 文件：04-向量存储-VectorDB/Milvus/01-集合和实体/02-collection.py

- 相对路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/02-collection.py`
- 大小：`5415` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/01-集合和实体/02-collection.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/02-collection.py)
