# 文件：07-检索后处理-PostRetrieval/02-压缩/02-LLMLingua压缩.py

- 相对路径：`07-检索后处理-PostRetrieval/02-压缩/02-LLMLingua压缩.py`
- 大小：`5317` bytes
- 原文件：[07-检索后处理-PostRetrieval/02-压缩/02-LLMLingua压缩.py](/learn/rag-in-action/repo-raw/rag-in-action/07-检索后处理-PostRetrieval/02-压缩/02-LLMLingua压缩.py)
