# 文件：01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb

- 相对路径：`01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb`
- 大小：`9808` bytes
- 原文件：[01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb)
