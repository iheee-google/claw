# 文件：05-检索前处理-PreRetrieval/02-查询翻译/02-查询分解-2-MultiQueryRetriever.py

- 相对路径：`05-检索前处理-PreRetrieval/02-查询翻译/02-查询分解-2-MultiQueryRetriever.py`
- 大小：`2411` bytes
- 原文件：[05-检索前处理-PreRetrieval/02-查询翻译/02-查询分解-2-MultiQueryRetriever.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/02-查询翻译/02-查询分解-2-MultiQueryRetriever.py)
