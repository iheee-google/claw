# 文件：01-数据导入-DataLoading/04-PDF文件读取/08-渲染PDF页面版式.py

- 相对路径：`01-数据导入-DataLoading/04-PDF文件读取/08-渲染PDF页面版式.py`
- 大小：`2164` bytes
- 原文件：[01-数据导入-DataLoading/04-PDF文件读取/08-渲染PDF页面版式.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/08-渲染PDF页面版式.py)
