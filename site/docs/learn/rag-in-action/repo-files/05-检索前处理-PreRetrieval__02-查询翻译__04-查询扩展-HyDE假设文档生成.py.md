# 文件：05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py

- 相对路径：`05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py`
- 大小：`2187` bytes
- 原文件：[05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py)
