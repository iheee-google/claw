# 文件：06-索引优化-Indexing/02-构建有层次的索引/98-双层索引-FAISS.py

- 相对路径：`06-索引优化-Indexing/02-构建有层次的索引/98-双层索引-FAISS.py`
- 大小：`3450` bytes
- 原文件：[06-索引优化-Indexing/02-构建有层次的索引/98-双层索引-FAISS.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/98-双层索引-FAISS.py)
