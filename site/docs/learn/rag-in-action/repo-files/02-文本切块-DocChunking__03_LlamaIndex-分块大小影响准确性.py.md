# 文件：02-文本切块-DocChunking/03_LlamaIndex-分块大小影响准确性.py

- 相对路径：`02-文本切块-DocChunking/03_LlamaIndex-分块大小影响准确性.py`
- 大小：`1452` bytes
- 原文件：[02-文本切块-DocChunking/03_LlamaIndex-分块大小影响准确性.py](/learn/rag-in-action/repo-raw/rag-in-action/02-文本切块-DocChunking/03_LlamaIndex-分块大小影响准确性.py)
