# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v1-error.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v1-error.py`
- 大小：`4276` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v1-error.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/05-text2sql-rag-v1-error.py)
