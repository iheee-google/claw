# 文件：00-简单RAG-SimpleRAG/05_RAG_from_Scratch_DeepSeek.py

- 相对路径：`00-简单RAG-SimpleRAG/05_RAG_from_Scratch_DeepSeek.py`
- 大小：`3655` bytes
- 原文件：[00-简单RAG-SimpleRAG/05_RAG_from_Scratch_DeepSeek.py](/learn/rag-in-action/repo-raw/rag-in-action/00-简单RAG-SimpleRAG/05_RAG_from_Scratch_DeepSeek.py)
