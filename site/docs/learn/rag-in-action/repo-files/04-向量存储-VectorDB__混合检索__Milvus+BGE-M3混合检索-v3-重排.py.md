# 文件：04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v3-重排.py

- 相对路径：`04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v3-重排.py`
- 大小：`7192` bytes
- 原文件：[04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v3-重排.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/混合检索/Milvus+BGE-M3混合检索-v3-重排.py)
