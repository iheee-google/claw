# 文件：01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py

- 相对路径：`01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py`
- 大小：`2195` bytes
- 原文件：[01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py)
