# 文件：05-检索前处理-PreRetrieval/03-查询路由/02-语义路由.py

- 相对路径：`05-检索前处理-PreRetrieval/03-查询路由/02-语义路由.py`
- 大小：`1671` bytes
- 原文件：[05-检索前处理-PreRetrieval/03-查询路由/02-语义路由.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/03-查询路由/02-语义路由.py)
