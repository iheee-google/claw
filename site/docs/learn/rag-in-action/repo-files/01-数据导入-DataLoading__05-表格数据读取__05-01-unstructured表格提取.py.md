# 文件：01-数据导入-DataLoading/05-表格数据读取/05-01-unstructured表格提取.py

- 相对路径：`01-数据导入-DataLoading/05-表格数据读取/05-01-unstructured表格提取.py`
- 大小：`3661` bytes
- 原文件：[01-数据导入-DataLoading/05-表格数据读取/05-01-unstructured表格提取.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/05-01-unstructured表格提取.py)
