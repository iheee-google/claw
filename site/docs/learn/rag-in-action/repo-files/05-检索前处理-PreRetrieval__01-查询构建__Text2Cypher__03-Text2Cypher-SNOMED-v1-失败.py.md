# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v1-失败.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v1-失败.py`
- 大小：`3590` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v1-失败.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2Cypher/03-Text2Cypher-SNOMED-v1-失败.py)
