# 文件：03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py

- 相对路径：`03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py`
- 大小：`1183` bytes
- 原文件：[03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py](/learn/rag-in-action/repo-raw/rag-in-action/03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py)
