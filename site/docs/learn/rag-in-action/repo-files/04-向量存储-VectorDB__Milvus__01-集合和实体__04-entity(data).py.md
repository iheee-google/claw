# 文件：04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py

- 相对路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py`
- 大小：`2896` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py)
