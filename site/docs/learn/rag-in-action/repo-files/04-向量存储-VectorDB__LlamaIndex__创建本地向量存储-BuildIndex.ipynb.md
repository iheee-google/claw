# 文件：04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb

- 相对路径：`04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb`
- 大小：`14917` bytes
- 原文件：[04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb)
