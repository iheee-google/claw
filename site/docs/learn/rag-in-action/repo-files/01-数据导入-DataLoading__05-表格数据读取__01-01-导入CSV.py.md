# 文件：01-数据导入-DataLoading/05-表格数据读取/01-01-导入CSV.py

- 相对路径：`01-数据导入-DataLoading/05-表格数据读取/01-01-导入CSV.py`
- 大小：`1365` bytes
- 原文件：[01-数据导入-DataLoading/05-表格数据读取/01-01-导入CSV.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/01-01-导入CSV.py)
