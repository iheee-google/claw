# 文件：01-数据导入-DataLoading/99-其它/15_LlamaParse_PDF.py

- 相对路径：`01-数据导入-DataLoading/99-其它/15_LlamaParse_PDF.py`
- 大小：`2630` bytes
- 原文件：[01-数据导入-DataLoading/99-其它/15_LlamaParse_PDF.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/99-其它/15_LlamaParse_PDF.py)
