# 文件：04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py

- 相对路径：`04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py`
- 大小：`2502` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py)
