# 文件：02-文本切块-DocChunking/99-工具-PDF-切割.py

- 相对路径：`02-文本切块-DocChunking/99-工具-PDF-切割.py`
- 大小：`1495` bytes
- 原文件：[02-文本切块-DocChunking/99-工具-PDF-切割.py](/learn/rag-in-action/repo-raw/rag-in-action/02-文本切块-DocChunking/99-工具-PDF-切割.py)
