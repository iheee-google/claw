# 文件：05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py`
- 大小：`3488` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py)
