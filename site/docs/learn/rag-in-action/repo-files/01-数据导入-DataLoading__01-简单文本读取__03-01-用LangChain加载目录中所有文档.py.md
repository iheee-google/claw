# 文件：01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py

- 相对路径：`01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py`
- 大小：`2936` bytes
- 原文件：[01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py)
