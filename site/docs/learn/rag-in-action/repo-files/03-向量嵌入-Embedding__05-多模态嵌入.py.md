# 文件：03-向量嵌入-Embedding/05-多模态嵌入.py

- 相对路径：`03-向量嵌入-Embedding/05-多模态嵌入.py`
- 大小：`1994` bytes
- 原文件：[03-向量嵌入-Embedding/05-多模态嵌入.py](/learn/rag-in-action/repo-raw/rag-in-action/03-向量嵌入-Embedding/05-多模态嵌入.py)
