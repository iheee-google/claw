# 文件：04-向量存储-VectorDB/Milvus/create_milvus_db.py

- 相对路径：`04-向量存储-VectorDB/Milvus/create_milvus_db.py`
- 大小：`7375` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/create_milvus_db.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/create_milvus_db.py)
