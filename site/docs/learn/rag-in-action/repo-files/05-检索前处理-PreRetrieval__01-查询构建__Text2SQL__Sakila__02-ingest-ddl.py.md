# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/02-ingest-ddl.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/02-ingest-ddl.py`
- 大小：`2605` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/02-ingest-ddl.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/02-ingest-ddl.py)
