# 文件：01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py

- 相对路径：`01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py`
- 大小：`1675` bytes
- 原文件：[01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py)
