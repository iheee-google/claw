# 文件：08-响应生成-Generation/02-通过提示词优化响应/01-使用提示模板明确生成目标.py

- 相对路径：`08-响应生成-Generation/02-通过提示词优化响应/01-使用提示模板明确生成目标.py`
- 大小：`1749` bytes
- 原文件：[08-响应生成-Generation/02-通过提示词优化响应/01-使用提示模板明确生成目标.py](/learn/rag-in-action/repo-raw/rag-in-action/08-响应生成-Generation/02-通过提示词优化响应/01-使用提示模板明确生成目标.py)
