# 文件：90-文档-Data/sakila/q2sql_pairs.json

- 相对路径：`90-文档-Data/sakila/q2sql_pairs.json`
- 大小：`5120` bytes
- 原文件：[90-文档-Data/sakila/q2sql_pairs.json](/learn/rag-in-action/repo-raw/rag-in-action/90-文档-Data/sakila/q2sql_pairs.json)
