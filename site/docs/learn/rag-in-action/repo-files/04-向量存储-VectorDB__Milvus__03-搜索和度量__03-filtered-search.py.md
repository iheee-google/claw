# 文件：04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py

- 相对路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py`
- 大小：`2998` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py)
