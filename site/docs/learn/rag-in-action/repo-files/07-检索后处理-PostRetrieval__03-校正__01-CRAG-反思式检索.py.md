# 文件：07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索.py

- 相对路径：`07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索.py`
- 大小：`16614` bytes
- 原文件：[07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索.py](/learn/rag-in-action/repo-raw/rag-in-action/07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索.py)
