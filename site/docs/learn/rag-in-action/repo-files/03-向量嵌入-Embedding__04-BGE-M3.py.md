# 文件：03-向量嵌入-Embedding/04-BGE-M3.py

- 相对路径：`03-向量嵌入-Embedding/04-BGE-M3.py`
- 大小：`1268` bytes
- 原文件：[03-向量嵌入-Embedding/04-BGE-M3.py](/learn/rag-in-action/repo-raw/rag-in-action/03-向量嵌入-Embedding/04-BGE-M3.py)
