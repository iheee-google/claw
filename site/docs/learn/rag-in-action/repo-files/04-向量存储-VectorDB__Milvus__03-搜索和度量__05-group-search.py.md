# 文件：04-向量存储-VectorDB/Milvus/03-搜索和度量/05-group-search.py

- 相对路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/05-group-search.py`
- 大小：`2978` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/03-搜索和度量/05-group-search.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/05-group-search.py)
