# 文件：06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py

- 相对路径：`06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py`
- 大小：`10229` bytes
- 原文件：[06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py)
