# 文件：06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py

- 相对路径：`06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py`
- 大小：`7892` bytes
- 原文件：[06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py)
