# 文件：04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py

- 相对路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py`
- 大小：`4398` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py)
