# 文件：04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py

- 相对路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py`
- 大小：`3227` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py)
