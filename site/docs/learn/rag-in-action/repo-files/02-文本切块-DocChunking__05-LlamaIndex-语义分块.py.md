# 文件：02-文本切块-DocChunking/05-LlamaIndex-语义分块.py

- 相对路径：`02-文本切块-DocChunking/05-LlamaIndex-语义分块.py`
- 大小：`2789` bytes
- 原文件：[02-文本切块-DocChunking/05-LlamaIndex-语义分块.py](/learn/rag-in-action/repo-raw/rag-in-action/02-文本切块-DocChunking/05-LlamaIndex-语义分块.py)
