# 文件：91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt

- 相对路径：`91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt`
- 大小：`2994` bytes
- 原文件：[91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt](/learn/rag-in-action/repo-raw/rag-in-action/91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt)
