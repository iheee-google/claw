# 文件：09-系统评估-Evaluation/02-Trulens.py

- 相对路径：`09-系统评估-Evaluation/02-Trulens.py`
- 大小：`6960` bytes
- 原文件：[09-系统评估-Evaluation/02-Trulens.py](/learn/rag-in-action/repo-raw/rag-in-action/09-系统评估-Evaluation/02-Trulens.py)
