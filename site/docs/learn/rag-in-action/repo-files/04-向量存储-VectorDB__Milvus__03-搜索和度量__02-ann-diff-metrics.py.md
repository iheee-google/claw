# 文件：04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py

- 相对路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py`
- 大小：`4359` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py)
