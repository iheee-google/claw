# 文件：01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py

- 相对路径：`01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py`
- 大小：`1279` bytes
- 原文件：[01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py)
