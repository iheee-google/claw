# 文件：08-响应生成-Generation/01-模型的选择和调用/02-微调Qwen3.py

- 相对路径：`08-响应生成-Generation/01-模型的选择和调用/02-微调Qwen3.py`
- 大小：`3312` bytes
- 原文件：[08-响应生成-Generation/01-模型的选择和调用/02-微调Qwen3.py](/learn/rag-in-action/repo-raw/rag-in-action/08-响应生成-Generation/01-模型的选择和调用/02-微调Qwen3.py)
