# 文件：06-索引优化-Indexing/02-构建有层次的索引/05-分层合并的示例.py

- 相对路径：`06-索引优化-Indexing/02-构建有层次的索引/05-分层合并的示例.py`
- 大小：`2980` bytes
- 原文件：[06-索引优化-Indexing/02-构建有层次的索引/05-分层合并的示例.py](/learn/rag-in-action/repo-raw/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/05-分层合并的示例.py)
