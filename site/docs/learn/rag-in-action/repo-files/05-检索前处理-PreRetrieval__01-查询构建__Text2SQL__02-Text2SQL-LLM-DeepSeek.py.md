# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/02-Text2SQL-LLM-DeepSeek.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/02-Text2SQL-LLM-DeepSeek.py`
- 大小：`3140` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/02-Text2SQL-LLM-DeepSeek.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/02-Text2SQL-LLM-DeepSeek.py)
