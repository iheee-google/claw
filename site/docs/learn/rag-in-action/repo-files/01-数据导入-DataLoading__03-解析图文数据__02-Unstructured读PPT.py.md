# 文件：01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py

- 相对路径：`01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py`
- 大小：`1149` bytes
- 原文件：[01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py](/learn/rag-in-action/repo-raw/rag-in-action/01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py)
