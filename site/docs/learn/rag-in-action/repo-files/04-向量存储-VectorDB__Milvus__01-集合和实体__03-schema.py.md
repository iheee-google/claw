# 文件：04-向量存储-VectorDB/Milvus/01-集合和实体/03-schema.py

- 相对路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/03-schema.py`
- 大小：`4082` bytes
- 原文件：[04-向量存储-VectorDB/Milvus/01-集合和实体/03-schema.py](/learn/rag-in-action/repo-raw/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/03-schema.py)
