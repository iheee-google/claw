# 文件：05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/03-ingest-q2sql.py

- 相对路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/03-ingest-q2sql.py`
- 大小：`2573` bytes
- 原文件：[05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/03-ingest-q2sql.py](/learn/rag-in-action/repo-raw/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/03-ingest-q2sql.py)
