...
- 原路径：`02-文本切块-DocChunking/04-LangChain-为代码普通分块.py`
- 原文件链接：[04-LangChain-为代码普通分块.py](/rag-in-action-repo/rag-in-action/02-文本切块-DocChunking/04-LangChain-为代码普通分块.py)
