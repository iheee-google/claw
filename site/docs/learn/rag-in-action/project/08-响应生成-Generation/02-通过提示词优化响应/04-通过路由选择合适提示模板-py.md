...
- 原路径：`08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py`
- 原文件链接：[04-通过路由选择合适提示模板.py](/rag-in-action-repo/rag-in-action/08-响应生成-Generation/02-通过提示词优化响应/04-通过路由选择合适提示模板.py)
