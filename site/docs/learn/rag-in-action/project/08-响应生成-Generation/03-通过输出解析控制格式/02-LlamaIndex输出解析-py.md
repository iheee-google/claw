...
- 原路径：`08-响应生成-Generation/03-通过输出解析控制格式/02-LlamaIndex输出解析.py`
- 原文件链接：[02-LlamaIndex输出解析.py](/rag-in-action-repo/rag-in-action/08-响应生成-Generation/03-通过输出解析控制格式/02-LlamaIndex输出解析.py)
