...
- 原路径：`06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py`
- 原文件链接：[02-双层索引-Milvus-成功的分层索引.py](/rag-in-action-repo/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/02-双层索引-Milvus-成功的分层索引.py)
