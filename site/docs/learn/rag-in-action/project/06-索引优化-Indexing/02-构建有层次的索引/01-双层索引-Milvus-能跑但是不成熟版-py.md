...
- 原路径：`06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py`
- 原文件链接：[01-双层索引-Milvus-能跑但是不成熟版.py](/rag-in-action-repo/rag-in-action/06-索引优化-Indexing/02-构建有层次的索引/01-双层索引-Milvus-能跑但是不成熟版.py)
