...
- 原路径：`06-索引优化-Indexing/03-构建多表示的索引/02-用MultiVectorRetriever构建多表示索引.py`
- 原文件链接：[02-用MultiVectorRetriever构建多表示索引.py](/rag-in-action-repo/rag-in-action/06-索引优化-Indexing/03-构建多表示的索引/02-用MultiVectorRetriever构建多表示索引.py)
