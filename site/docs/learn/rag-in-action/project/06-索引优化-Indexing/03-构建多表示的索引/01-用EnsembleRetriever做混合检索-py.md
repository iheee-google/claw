...
- 原路径：`06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py`
- 原文件链接：[01-用EnsembleRetriever做混合检索.py](/rag-in-action-repo/rag-in-action/06-索引优化-Indexing/03-构建多表示的索引/01-用EnsembleRetriever做混合检索.py)
