...
- 原路径：`07-检索后处理-PostRetrieval/01-重排/02-CrossEncoder重排.py`
- 原文件链接：[02-CrossEncoder重排.py](/rag-in-action-repo/rag-in-action/07-检索后处理-PostRetrieval/01-重排/02-CrossEncoder重排.py)
