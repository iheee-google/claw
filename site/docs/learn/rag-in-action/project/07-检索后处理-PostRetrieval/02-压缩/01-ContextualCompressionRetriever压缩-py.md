...
- 原路径：`07-检索后处理-PostRetrieval/02-压缩/01-ContextualCompressionRetriever压缩.py`
- 原文件链接：[01-ContextualCompressionRetriever压缩.py](/rag-in-action-repo/rag-in-action/07-检索后处理-PostRetrieval/02-压缩/01-ContextualCompressionRetriever压缩.py)
