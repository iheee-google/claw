...
- 原路径：`00-简单RAG-SimpleRAG/03_LangChain_LCEL_RAG_v2.py`
- 原文件链接：[03_LangChain_LCEL_RAG_v2.py](/rag-in-action-repo/rag-in-action/00-简单RAG-SimpleRAG/03_LangChain_LCEL_RAG_v2.py)
