...
- 原路径：`00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py`
- 原文件链接：[01_03_LlamaIndex_更换生成模型.py](/rag-in-action-repo/rag-in-action/00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换生成模型.py)
