...
- 原路径：`00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Claude.py`
- 原文件链接：[05_RAG_from_Scratch_Claude.py](/rag-in-action-repo/rag-in-action/00-简单RAG-SimpleRAG/05_RAG_from_Scratch_Claude.py)
