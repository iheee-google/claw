...
- 原路径：`00-简单RAG-SimpleRAG/01_02_LlamaIndex_更换嵌入模型.py`
- 原文件链接：[01_02_LlamaIndex_更换嵌入模型.py](/rag-in-action-repo/rag-in-action/00-简单RAG-SimpleRAG/01_02_LlamaIndex_更换嵌入模型.py)
