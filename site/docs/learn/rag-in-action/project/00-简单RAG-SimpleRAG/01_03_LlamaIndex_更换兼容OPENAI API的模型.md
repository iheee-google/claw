...
- 原路径：`00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型`
- 原文件链接：[01_03_LlamaIndex_更换兼容OPENAI API的模型](/rag-in-action-repo/rag-in-action/00-简单RAG-SimpleRAG/01_03_LlamaIndex_更换兼容OPENAI API的模型)
