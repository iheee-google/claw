...
- 原路径：`03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py`
- 原文件链接：[02-jina-embeddings-v3-clustering.py](/rag-in-action-repo/rag-in-action/03-向量嵌入-Embedding/02-jina-embeddings-v3-clustering.py)
