...
- 原路径：`03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py`
- 原文件链接：[01-openai-embedding-recomendation-system.py](/rag-in-action-repo/rag-in-action/03-向量嵌入-Embedding/01-openai-embedding-recomendation-system.py)
