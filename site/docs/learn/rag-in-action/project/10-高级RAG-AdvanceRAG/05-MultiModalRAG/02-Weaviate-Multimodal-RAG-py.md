...
- 原路径：`10-高级RAG-AdvanceRAG/05-MultiModalRAG/02-Weaviate-Multimodal-RAG.py`
- 原文件链接：[02-Weaviate-Multimodal-RAG.py](/rag-in-action-repo/rag-in-action/10-高级RAG-AdvanceRAG/05-MultiModalRAG/02-Weaviate-Multimodal-RAG.py)
