...
- 原路径：`10-高级RAG-AdvanceRAG/05-MultiModalRAG/01-Weaviate-Multimodal-Search.py`
- 原文件链接：[01-Weaviate-Multimodal-Search.py](/rag-in-action-repo/rag-in-action/10-高级RAG-AdvanceRAG/05-MultiModalRAG/01-Weaviate-Multimodal-Search.py)
