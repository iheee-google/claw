...
- 原路径：`05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py`
- 原文件链接：[04-查询扩展-HyDE假设文档生成.py](/rag-in-action-repo/rag-in-action/05-检索前处理-PreRetrieval/02-查询翻译/04-查询扩展-HyDE假设文档生成.py)
