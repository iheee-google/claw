...
- 原路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/01-Text2SQL-创建数据库表.py`
- 原文件链接：[01-Text2SQL-创建数据库表.py](/rag-in-action-repo/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/01-Text2SQL-创建数据库表.py)
