...
- 原路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py`
- 原文件链接：[04-ingest-db-desc.py](/rag-in-action-repo/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/04-ingest-db-desc.py)
