...
- 原路径：`05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/01-generate-ddl.py`
- 原文件链接：[01-generate-ddl.py](/rag-in-action-repo/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/Text2SQL/Sakila/01-generate-ddl.py)
