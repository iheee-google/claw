...
- 原路径：`05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py`
- 原文件链接：[02-Query中生成元数据.py](/rag-in-action-repo/rag-in-action/05-检索前处理-PreRetrieval/01-查询构建/构建元数据Filter/02-Query中生成元数据.py)
