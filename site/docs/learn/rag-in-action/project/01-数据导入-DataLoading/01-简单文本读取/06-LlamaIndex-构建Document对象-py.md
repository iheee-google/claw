...
- 原路径：`01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py`
- 原文件链接：[06-LlamaIndex-构建Document对象.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/06-LlamaIndex-构建Document对象.py)
