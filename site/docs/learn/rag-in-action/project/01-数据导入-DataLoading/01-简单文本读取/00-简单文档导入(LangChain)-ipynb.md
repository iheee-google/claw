...
- 原路径：`01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb`
- 原文件链接：[00-简单文档导入(LangChain).ipynb](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/00-简单文档导入(LangChain).ipynb)
