...
- 原路径：`01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py`
- 原文件链接：[03-01-用LangChain加载目录中所有文档.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/03-01-用LangChain加载目录中所有文档.py)
