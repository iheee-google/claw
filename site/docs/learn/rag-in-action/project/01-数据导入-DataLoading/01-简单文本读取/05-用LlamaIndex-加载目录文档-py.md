...
- 原路径：`01-数据导入-DataLoading/01-简单文本读取/05-用LlamaIndex-加载目录文档.py`
- 原文件链接：[05-用LlamaIndex-加载目录文档.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/01-简单文本读取/05-用LlamaIndex-加载目录文档.py)
