...
- 原路径：`01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py`
- 原文件链接：[05-02-Unstrutured-整理父子元素.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/02-结构化文档读取/05-02-Unstrutured-整理父子元素.py)
