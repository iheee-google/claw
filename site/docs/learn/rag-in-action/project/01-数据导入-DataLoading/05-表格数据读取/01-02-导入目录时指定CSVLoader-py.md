...
- 原路径：`01-数据导入-DataLoading/05-表格数据读取/01-02-导入目录时指定CSVLoader.py`
- 原文件链接：[01-02-导入目录时指定CSVLoader.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/01-02-导入目录时指定CSVLoader.py)
