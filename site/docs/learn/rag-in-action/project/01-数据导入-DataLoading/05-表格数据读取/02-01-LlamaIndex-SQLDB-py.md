...
- 原路径：`01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py`
- 原文件链接：[02-01-LlamaIndex-SQLDB.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/02-01-LlamaIndex-SQLDB.py)
