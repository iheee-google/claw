...
- 原路径：`01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py`
- 原文件链接：[05-02-unstructured表格提取+上下文.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/05-表格数据读取/05-02-unstructured表格提取+上下文.py)
