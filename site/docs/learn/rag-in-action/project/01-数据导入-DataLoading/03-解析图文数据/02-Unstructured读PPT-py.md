...
- 原路径：`01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py`
- 原文件链接：[02-Unstructured读PPT.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/03-解析图文数据/02-Unstructured读PPT.py)
