...
- 原路径：`01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py`
- 原文件链接：[05-LangChain-Unstrucured-PDF-提取文档结构.py](/rag-in-action-repo/rag-in-action/01-数据导入-DataLoading/04-PDF文件读取/05-LangChain-Unstrucured-PDF-提取文档结构.py)
