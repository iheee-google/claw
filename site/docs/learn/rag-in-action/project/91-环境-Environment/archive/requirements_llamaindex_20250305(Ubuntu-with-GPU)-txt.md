...
- 原路径：`91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt`
- 原文件链接：[requirements_llamaindex_20250305(Ubuntu-with-GPU).txt](/rag-in-action-repo/rag-in-action/91-环境-Environment/archive/requirements_llamaindex_20250305(Ubuntu-with-GPU).txt)
