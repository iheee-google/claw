...
- 原路径：`91-环境-Environment/requirements_llamaindex_无GPU版_Mac-Win.txt`
- 原文件链接：[requirements_llamaindex_无GPU版_Mac-Win.txt](/rag-in-action-repo/rag-in-action/91-环境-Environment/requirements_llamaindex_无GPU版_Mac-Win.txt)
