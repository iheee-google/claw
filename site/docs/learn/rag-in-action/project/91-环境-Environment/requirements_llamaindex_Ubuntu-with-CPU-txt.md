...
- 原路径：`91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt`
- 原文件链接：[requirements_llamaindex_Ubuntu-with-CPU.txt](/rag-in-action-repo/rag-in-action/91-环境-Environment/requirements_llamaindex_Ubuntu-with-CPU.txt)
