...
- 原路径：`04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb`
- 原文件链接：[创建本地向量存储-BuildIndex.ipynb](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/LlamaIndex/创建本地向量存储-BuildIndex.ipynb)
