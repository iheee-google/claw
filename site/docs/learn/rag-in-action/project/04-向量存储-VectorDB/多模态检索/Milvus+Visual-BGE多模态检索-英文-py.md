...
- 原路径：`04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py`
- 原文件链接：[Milvus+Visual-BGE多模态检索-英文.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE多模态检索-英文.py)
