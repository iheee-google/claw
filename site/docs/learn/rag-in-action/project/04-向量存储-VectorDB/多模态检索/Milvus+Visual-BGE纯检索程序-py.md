...
- 原路径：`04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE纯检索程序.py`
- 原文件链接：[Milvus+Visual-BGE纯检索程序.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/多模态检索/Milvus+Visual-BGE纯检索程序.py)
