...
- 原路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py`
- 原文件链接：[01-database.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/01-database.py)
