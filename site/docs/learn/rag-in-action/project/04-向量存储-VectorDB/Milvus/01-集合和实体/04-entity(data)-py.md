...
- 原路径：`04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py`
- 原文件链接：[04-entity(data).py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/01-集合和实体/04-entity(data).py)
