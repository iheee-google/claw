...
- 原路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py`
- 原文件链接：[09-metadata-query.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/09-metadata-query.py)
