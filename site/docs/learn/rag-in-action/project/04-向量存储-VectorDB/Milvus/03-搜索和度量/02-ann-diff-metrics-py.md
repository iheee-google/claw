...
- 原路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py`
- 原文件链接：[02-ann-diff-metrics.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/02-ann-diff-metrics.py)
