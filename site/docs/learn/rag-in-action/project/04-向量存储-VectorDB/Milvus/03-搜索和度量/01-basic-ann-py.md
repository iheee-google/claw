...
- 原路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/01-basic-ann.py`
- 原文件链接：[01-basic-ann.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/01-basic-ann.py)
