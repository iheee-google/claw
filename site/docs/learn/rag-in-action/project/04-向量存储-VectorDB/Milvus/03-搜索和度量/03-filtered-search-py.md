...
- 原路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py`
- 原文件链接：[03-filtered-search.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/03-filtered-search.py)
