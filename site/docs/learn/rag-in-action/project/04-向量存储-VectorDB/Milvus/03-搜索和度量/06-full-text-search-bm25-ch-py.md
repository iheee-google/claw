...
- 原路径：`04-向量存储-VectorDB/Milvus/03-搜索和度量/06-full-text-search-bm25-ch.py`
- 原文件链接：[06-full-text-search-bm25-ch.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/03-搜索和度量/06-full-text-search-bm25-ch.py)
