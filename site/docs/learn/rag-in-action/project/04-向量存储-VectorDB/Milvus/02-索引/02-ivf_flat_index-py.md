...
- 原路径：`04-向量存储-VectorDB/Milvus/02-索引/02-ivf_flat_index.py`
- 原文件链接：[02-ivf_flat_index.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/02-索引/02-ivf_flat_index.py)
