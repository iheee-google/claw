...
- 原路径：`04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py`
- 原文件链接：[03-ivf_pq_index.py](/rag-in-action-repo/rag-in-action/04-向量存储-VectorDB/Milvus/02-索引/03-ivf_pq_index.py)
